...
> **Welcome to Product-Track Week 3, Task 7!**
...
| `src/aggregator.go` | Main source code - **has bugs to fix** |
| `src/windowManager.go` | Supporting code - **may also have bugs** |
| `tests/aggregator_test.go` | Test file - **add your tests here** |
